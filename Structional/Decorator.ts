...
// + Принцип единственной ответственности . Монолитный класс, реализующий множество возможных вариантов поведения, можно разделить на несколько более мелких классов.
// - Удалить конкретный объект-обертку из стека оберток довольно сложно.
// - Сложно реализовать декоратор таким образом, чтобы его поведение не зависело от порядка его расположения в стеке декораторов.
