//  если хотите применять различные варианты алгоритма
...
// связывая его с различными подобъектами, которые могут выполнять определенные подзадачи
// разными способами.
...
// - Многие современные языки программирования поддерживают функциональную типизацию, позволяющую
// реализовывать различные версии алгоритма внутри набора анонимных функций.
// Таким образом, эти функции можно использовать точно так же,
...
// Используйте эту стратегию, когда у вас много похожих классов, которые отличаются
//  только способом выполнения определенного действия.
