// позволяет определить основу алгоритма в базовом классе и позволить подклассам переопределять шаги
//  без изменения общей структуры алгоритма.
...
// - Вы можете нарушить принцип подстановки Лискова ,
//   подавив реализацию шага по умолчанию с помощью подкласса.
