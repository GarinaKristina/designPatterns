...
// Паттерн «Фасад» следует использовать, когда необходим ограниченный, но простой интерфейс для
// доступа к сложной подсистеме.
...
// Abstract Factory может служить альтернативой Facade , если вам нужно скрыть от клиентского кода
//  только способ создания объектов подсистемы.
// Класс Facade часто можно преобразовать в Singleton, поскольку в большинстве случаев достаточно
// одного объекта - фасада.
